...
import DiscountedProducts from '../../components/ContainerWithFilter/DiscountedProducts/DiscountedProducts';
...
function ProductsByCategorie() {
  ...
  return (
    <div className="globalContainer">
      <div className={styles.productsByCategorie}>
        <BreadCrumbs
          items={[
